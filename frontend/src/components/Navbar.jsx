        ...
        <Container className="d-flex flex-column p-0 h-100" fluid>
          <div className="sidebar-header">
            <Navbar.Brand className="p-3 d-flex align-items-center">
              ...
              />
              <span className="brand-text">Lutenix</span>
            </Navbar.Brand>
          </div>
          ...
          <div className="sidebar-footer">
            ...
            <div className="social-links">
              <a href="https://twitter.com/lutenixsec" target="_blank" rel="noopener noreferrer">
                <i className="bi bi-twitter"></i>
              </a>
              <a href="https://youtube.com/lutenixsec" target="_blank" rel="noopener noreferrer">
                <i className="bi bi-youtube"></i>
              </a>
              <a href="https://github.com/lutenixsec" target="_blank" rel="noopener noreferrer">
